...
export function GoogleSignInButton({ label }: { label: string }) {
  ...
  return (
    <button
      ...
      className="flex w-full items-center justify-center gap-3 rounded-md border border-white/20 bg-white px-3 py-2.5 text-sm font-medium text-slate-800 transition hover:bg-slate-100 disabled:opacity-60"
    >
      <GoogleMark />
...
function GoogleMark() {
  return (
    <svg width="18" height="18" viewBox="0 0 48 48" aria-hidden="true">
      ...
      <path
        fill="#1976D2"
        d="M43.6 20.5H42V20H24v8h11.3c-1.1 3.2-3.5 5.7-6.7 7.1l6.3 5.3C38.2 37.4 44 32 44 24c0-1.3-.1-2.3-.4-3.5z"
      />
    </svg>
  )
}
