      ...
      <ReactMarkdown
        ...
        components={{
          a: ({ href, children, ...rest }) => {
            if (href?.startsWith("/")) {
              return (
                <Link href={href} className="font-medium text-rose-400 underline underline-offset-2 hover:text-rose-300" {...rest}>
                  {children}
                </Link>
              )
            }
